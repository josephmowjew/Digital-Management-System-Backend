...
namespace DataStore.Migrations
{
    ...
    [Migration("20250206132706_Added Senior and Junior Lawyer fees to the CPD Trainings Table")]
    partial class AddedSeniorandJuniorLawyerfeestotheCPDTrainingsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserAttachment", b =>
                {
                    ...
                    b.Property<int>("ProfilePicturesId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUsersId", "ProfilePicturesId");

                    b.HasIndex("ProfilePicturesId");
            ...
            modelBuilder.Entity("AttachmentSubcommitteeMessage", b =>
                {
                    b.Property<int>("AttachmentsId")
                        .HasColumnType("int");

                    b.Property<int>("SubcommitteeMessagesId")
                        .HasColumnType("int");

                    b.HasKey("AttachmentsId", "SubcommitteeMessagesId");

                    b.HasIndex("SubcommitteeMessagesId");

                    b.ToTable("AttachmentSubcommitteeMessage");
                });
            ...
            modelBuilder.Entity("DataStore.Core.Models.ApplicationUserChangeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplicationUserChangeRequests");
                });
            ...
            modelBuilder.Entity("DataStore.Core.Models.CPDTraining", b =>
                {
                    ...
                    b.Property<bool>("IsCategorizedForMembers")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsFree")
                        .HasColumnType("tinyint(1)");

                    b.Property<double?>("JuniorLawyerPhysicalAttendanceFee")
                        .HasColumnType("double");

                    b.Property<double?>("JuniorLawyerVirtualAttendanceFee")
                        .HasColumnType("double");
                    ...
                    b.Property<double?>("SeniorLawyerPhysicalAttendanceFee")
                        .HasColumnType("double");

                    b.Property<double?>("SeniorLawyerVirtualAttendanceFee")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("DataStore.Core.Models.LicenseApplication", b =>
                {
                    ...
                    b.Property<string>("ExplanationForMinimumNumberOfCLEUnits")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("ExplanationForNoContributionToSocialWelfare")
                        .HasMaxLength(250)
                        .HasColumnType("varchar(250)");
                    ...
                    b.Property<bool>("MadeContributionToSocialWelfare")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ApplicationUserAttachment", b =>
                {
                    ...
                    b.HasOne("DataStore.Core.Models.Attachment", null)
                        .WithMany()
                        .HasForeignKey("ProfilePicturesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AttachmentSubcommitteeMessage", b =>
                {
                    ...
                    b.HasOne("DataStore.Core.Models.SubcommitteeMessage", null)
                        .WithMany()
                        .HasForeignKey("SubcommitteeMessagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DataStore.Core.Models.InvoiceRequest", b =>
                {
                    b.HasOne("DataStore.Core.Models.Attachment", "Attachment")
                        .WithMany()
